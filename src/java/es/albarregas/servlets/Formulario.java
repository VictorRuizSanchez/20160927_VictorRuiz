...
public class Formulario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p>"+"Apellido: "+request.getParameter("apellido")+"</p>");
            String valor=request.getParameter("check");
            if(valor==null)
            {
                out.println("<p>Marca: No marcado</p>" );
            }
            if(valor!=null)
            {
                out.println("<p>Marca: Marcado</p>" );
            }
            out.println("</body>");
            out.println("<br/>");
            out.println("<br/>");
